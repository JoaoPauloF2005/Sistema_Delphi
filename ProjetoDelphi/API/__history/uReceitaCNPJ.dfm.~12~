object frmReceitaCNPJ: TfrmReceitaCNPJ
  Left = 0
  Top = 0
  BiDiMode = bdLeftToRight
  BorderStyle = bsDialog
  Caption = 'frmReceitaCNPJ'
  ClientHeight = 258
  ClientWidth = 393
  Color = clWhite
