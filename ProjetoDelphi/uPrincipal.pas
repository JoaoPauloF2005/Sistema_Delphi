...
begin
  ...
  begin
    // Verifique o texto do nó selecionado para abrir o formulário ou o relatório correspondente
    ...
    else if TreeView1.Selected.Text = 'Cadastro de Usuários' then
    begin
    ...
    else if TreeView1.Selected.Text = 'Usuários VS Ações' then
    begin
    ...
    else if TreeView1.Selected.Text = 'Relatório de Categorias' then
    begin
      CriarRelatorio(TfrmRelCadCategoria);
    end
    else if TreeView1.Selected.Text = 'Relatório de Clientes' then
    begin
      CriarRelatorio(TfrmRelCadCliente);
    end
    else if TreeView1.Selected.Text = 'Relatório de Ficha de Clientes' then
    begin
      CriarRelatorio(TfrmRelCadClienteFicha);
    end
    else if TreeView1.Selected.Text = 'Relatório de Produtos' then
    begin
      CriarRelatorio(TfrmRelCadProduto);
    end
